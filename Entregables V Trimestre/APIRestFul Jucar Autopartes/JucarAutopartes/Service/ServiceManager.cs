...
namespace Service
{
    public sealed class ServiceManager : IServiceManager
    {
        ...
        private readonly Lazy<IAutopartMaterialService> _autopartMaterialService;
        ...
        public ServiceManager(IRepositoryManager repositoryManager, ILoggerManager logger, IMapper mapper)
        {
            ...
            _autopartMaterialService = new Lazy<IAutopartMaterialService>(() =>
                new AutopartMaterialService(repositoryManager, logger, mapper));
        ...
        public IAutopartMaterialService AutopartMaterialService => _autopartMaterialService.Value;
    }
}
